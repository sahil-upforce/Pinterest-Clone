...
class IsBoardOwnerMixin(object):
    permission_denied_message = _("You are not the owner of this board - you cannot view it")
...
class IsPinOwnerMixin(object):
    permission_denied_message = _("You are not the owner of this pin - you cannot edit it")
